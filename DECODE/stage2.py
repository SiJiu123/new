...
class DANN(object):
    ...
    def DANN_model(self, celltype_num):
        ...
        # self.encoder_da = nn.Sequential(EncoderBlock(feature_num, 128, 0), 
        #                                 EncoderBlock(128, 64, 0.3))

        # self.predictor_da = nn.Sequential(EncoderBlock(64, 32, 0.2), 
        #                                   nn.Linear(32, celltype_num), 
        #                                   nn.Softmax(dim=1))
        
        # self.discriminator_da = nn.Sequential(EncoderBlock(64, 32, 0.2), 
        #                                       nn.Linear(32, 1), 
        #                                       nn.Sigmoid())
