...
def get_option_list(dataset):
	...
	if dataset == 'human_lung_RNA':
		# Input parameters
		option_list['data_dir']='../data'
		option_list['ref_dataset_name'] = '296C_train.h5ad'
		option_list['ref_metadata_name'] = None
		option_list['target_dataset_name'] = '302C_test.h5ad'
		option_list['target_metadata_name'] = None
		option_list['random_type']="CellType"
		option_list['type_list']=['Luminal_Macrophages', 'Type 2 alveolar', 'Fibroblasts', 'Dendritic cells']
		# Training parameters
