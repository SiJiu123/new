...
from demo3 import demo3 as DemoModel
...
OUT_PRED = "demo3_preds.csv"
OUT_METRICS = "demo3_metrics_summary.csv"
OUT_TYPEWISE = "demo3_typewise_ccc.csv"
OUT_PROTO_DIR = "demo3_prototype_vis"
...
def main():
    if not torch.cuda.is_available():
        raise RuntimeError("demo3.py uses cuda directly. Please run on a CUDA-enabled machine.")
